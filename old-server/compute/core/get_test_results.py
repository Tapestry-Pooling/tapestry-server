...
MSizeToLabelDict = {
    ...
    "24x80":     ("optimized_M_24_80_kirkman", 6, 7.5),

    "27x117":     ("optimized_M_27_117_kirkman", 5, 4.5),

    "36x72":     ("optimized_M_36_72_kirkman", 7, 4.5),

    #"45x105":    ("optimized_M_45_105_STS_1", 8, 8),
    "45x105":    ("optimized_M_45_105_kirkman", 10,10),

    #"45x195":    ("optimized_M_45_195_STS_1", 8, 4),
    "45x195":    ("optimized_M_45_195_kirkman", 10, 5),

    "48x320":    ("optimized_M_48_320_kirkman", 10, 3.1),
...
mat_codenames = {
    ...
    'optimized_M_24_80_kirkman':                'SEAL',

    'optimized_M_27_117_kirkman':               'OTTER',

    "optimized_M_36_72_kirkman":                'PENGUIN', 
    ...
    "optimized_M_48_320_kirkman":               'PANDA',
...
def get_test_results(matrix_label, cycle_times, n=None):
  ...
  # Detect discrepancies in COMP results
  #
  # In case of error, change the result string to a conservative estimate
  errors = app_utils.detect_errors_and_get_conservative_results(M,
      cycle_times)
  if errors['errors']:
    res['result_string'] = errors['result_string']
...
def get_result_string_from_lists(sure_list, unsure_list, neg_list, x, n, algo):
  ...
  x_str = ""
  if algo != 'COMP' and algo != 'precise_SBL_COMP':
