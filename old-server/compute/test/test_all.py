...
def test_all_matrices_and_algos():
  algos = []
  algos.extend(['COMP'])
  algos.append('precise_SBL_COMP')
  algos.append('precise_SBL_combined_COMP_SBL')
  algos.append('precise_SBL_combined_COMP_NNOMP_random_cv')
  algos.append('SBL_clustered')
  algos.append('combined_COMP_SBL_clustered')
  algos.append('NNOMP')
